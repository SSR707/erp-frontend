...
import { useGetCourse } from "../courses/service/query/useGetAllCourse";
import { usePostGroupCreate } from "./service/mutation/usePostGroupCreate";
import { useGetTeachers } from "../teachers/service/query/useGetTeachers";
type FieldType = {
  name: string;
  courseId: string;
  start_date: Dayjs;
...
const GroupCreate = () => {
  ...
  const { data: CourseData } = useGetCourse(1, 1000);
  const { data: TeacherData } = useGetTeachers(1, 1000);
