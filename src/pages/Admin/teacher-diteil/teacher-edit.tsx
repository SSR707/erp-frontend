...
import { usePostTeacherUploadImg } from "@/pages/Admin/teacher-create/service/mutation/usePostTeacherUploadImg";
import dayjs, { Dayjs } from "dayjs";
import { useNavigate, useParams } from "react-router-dom";
import { useGetTeacherById } from "./service/query/useGetTeacherById";
import { usePatchReacher } from "./service/mutation/usePatchTeacher";
...
const TeacherEdit = () => {
  ...
  const { mutate: EditTeacher, isPending } = usePatchReacher();
